...
def test_q_homogene_horizontal():
	hamt = set_up_hamt()
	...
	hamt.data.mesh2d_triangular.set_boundary_value("l_right_buttom", 100.0)
	hamt.data.mesh2d_triangular.set_boundary_value("l_right_top", 100.0)
...
def test_q_heterogen_horizontal():
	hamt = set_up_hamt()
