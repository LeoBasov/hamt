...
Vector3d CalcGradientDiff(
    const Vector3d& pointing_vec);  // calculates the vector from distance vector of two points which when pultiplied
                                    // with the value distance of two points equals the gradient
