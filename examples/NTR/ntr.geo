...
Transfinite Surface {4} = {6, 14, 15, 7};
Transfinite Surface {3} = {9, 10, 6, 2};
Transfinite Surface {5} = {10, 18, 14, 6};
Transfinite Surface {6} = {21, 22, 18, 10};

Transfinite Curve {4, 2, 6, 9} = N+1 Using Progression 1;
Transfinite Curve {13, 12, 15} = 3*N+1 Using Progression 1;
Transfinite Curve {18, 17} = N+1 Using Progression 1;
Transfinite Curve {3, 1} = 10*N+1 Using Progression 1;
Transfinite Curve {7, 5, 11} = 30*N+1 Using Progression 1;
Transfinite Curve {10, 8, 14, 16} = N+1 Using Progression 1;
